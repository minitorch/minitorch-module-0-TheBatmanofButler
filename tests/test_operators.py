...
def test_sigmoid(a: float) -> None:
    ...
    * It is strictly increasing.
    ...
    assert(round(1 - result, 3) == round(sigmoid(-a), 3))
    assert(sigmoid(0) == 0.5)

    assert(sigmoid(a) <= sigmoid(a + 5))
    assert(sigmoid(a - 5) <= sigmoid(a))
...
def test_symmetric() -> None:
    ...
    """
    # TODO: Implement for Task 0.2.
    assert mul(5, 10) == mul(10, 5)
    assert mul(5.3, 10.1) == mul(10.1, 5.3)
    assert mul(-5, -10) == mul(-10, -5)
...
def test_distribute() -> None:
    ...
    """
    # TODO: Implement for Task 0.2.
    assert mul(5, (10 + 15)) == mul(5, 10) + mul(5, 15)
...
def test_sum_distribute(ls1: List[float], ls2: List[float]) -> None:
    ...
    assert round(sum(addLists(ls1, ls2)), 3) == round(sum(ls1) + sum(ls2), 3)
